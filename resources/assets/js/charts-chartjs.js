  ...
  if (lineChart) {
    const lineChartVar = new Chart(lineChart, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [80, 150, 180, 270, 210, 160, 160, 202, 265, 210, 270],
            label: 'Product',
          ...
          {
            data: [80, 125, 105, 130, 215, 195, 140, 160, 230, 300, 220],
            label: 'Prediction',
    ...
    monthlyButton.addEventListener('click', function () {
      // Update the chart data for monthly view
      lineChartVar.data.labels = ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July', 'Aug', 'Sept', 'Nov', 'Dec'];
      lineChartVar.update();
    });

    // Event listener for the yearly button
    yearlyButton.addEventListener('click', function () {
      // Update the chart data for yearly view
      lineChartVar.data.labels = ['2021', '2022', '2023', '2024']; // Update with your desired yearly labels
      lineChartVar.update();
    });
  }
